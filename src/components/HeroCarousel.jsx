          ...
          <div className="relative h-full flex items-center">
            <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 w-full">
              ...
              >
                ...
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-heading font-bold text-white leading-tight mb-3 drop-shadow-lg">
                  {slide.title}
                </h1>
                <h2 className="text-xl sm:text-2xl font-medium text-white/90 mb-4 drop-shadow">
                  {slide.subtitle}
                </h2>
